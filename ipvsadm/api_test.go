...
func fake(exec string, args... string) error {
	switch exec {
	case "which": return nil
	case "ipvsadm":
		switch args[0] {
		case "-A": return addVip(args[2], args[4], args[5])
		case "-D": return removeVip(args[2])
		case "-a": return addServer(args[2], args[3], args[5])
		case "-d": return removeServer(args[2], args[3])
		default : return errors.New("invalid option")
		}
	default:
